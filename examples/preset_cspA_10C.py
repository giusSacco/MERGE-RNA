#!/usr/bin/env python3
"""
Preset: Fit cspA RNA at 10°C.

This example loads the cspA experimental data at 10°C and runs fitting.
cspA is a cold-shock protein mRNA with well-characterized structure.

Usage:
    cd $RNA_STRUCT_HOME
    python examples/preset_cspA_10C.py
"""
import os
import sys
...
# Load experiments
# =============================================================================
experiments = [Experiment(path) for path in Experiment.paths_to_cspA_10C_data_txt]
...
print(f"\nFit complete! Results saved to {OUTPUT_DIR}/cspA_10C/")
